...
- Maintain a reusable personal info header for name and contact details
...
- The saved JSON includes `personalInfo`, `education`, chunk libraries, and per-job `profiles`
